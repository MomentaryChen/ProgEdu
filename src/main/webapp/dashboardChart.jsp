			...
			<div class="card-block">
				...
				<div class="tab-content text-center" style="margin-top: 10px">
					<div class="tab-pane active col-md-12" id="chart1" role="tabpanel">
						<div class="col-md-12" id="chart1Demo" style="width: 1200px; height: 400px; margin: 0 auto"></div>
					</div>
					<div class="tab-pane col-md-12" id="chart2" role="tabpanel">
						<div class="col-md-12" id="chart2Demo" style="min-width: 310px; max-width: 1200px; height: 400px; margin: 0 auto"></div>
					</div>
